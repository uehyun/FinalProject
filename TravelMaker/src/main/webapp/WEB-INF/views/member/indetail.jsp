    		...
    		<div class="col-lg-12 col-md-12 padding-right-30" style="width:100%">
                <div class="blog-post single-post">
                	<div class="post-content" style="height: 100%;">
						...
						<form method="post" action="/member/indelete" id="inboard">
...
ListBtn.on("click", function(){
	inboard.attr("action", "/member/inlist")
...
ModBtn.on("click",function(){
	inboard.attr("action", "/member/inmodify")
	inboard.attr("method", "get")
	//console.log("체킁 : ",inboard)
...
function replyList() {
    commentArea.empty();
    $.ajax({
        url :"/member/replyList?inqBoardNo=" + inqBoardNo.val(),
        type : "get",
        success : function(res){
            if(res.result === "SUCCESS") {
