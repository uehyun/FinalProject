...
#btn-all-close {
  ...
  border: none;
  color: #fff; style="background-color: white;"
  cursor: pointer;
  padding: 10px 25px;
  float: right;
}
...
<div class="container">
    <h3 style="text-align: center; padding-top: 50px;">
		문의사항 관리
      <small class="text-muted">&nbsp; 문의사항 관리</small>
    </h3>
    <br>
    <!-- 글 검색창	-->
	        ...
	        <tr style="background-color: white;">
	          ...
	          <td class="text-left" width="50%">
	            <div class="panel-faq-container">
	              <p class="panel-faq-title"><a href="detail?inqBoardNo=${inquiry.inqBoardNo }">${inquiry.inqBoardTitle }</a></p>
	            </div>
	          </td>
	        <!-- 우산없늗네 노란우산 빌려줘 -->
...
// 		location.href = "/admin/inquiry/register";
// 	});
});
